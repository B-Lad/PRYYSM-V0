...
import { LC_SEED } from './data/seed.js';
...
import { Machines } from './modules/Machines.jsx';
...
import { DeptCost } from './modules/DeptCost.jsx';
...
export default function App() {
    ...
    const [lcProjects, setLcProjects] = useState(LC_SEED);
    ...
    const sections = {
        ...
        spares: <SpareStores />,
        flow: <Flow />,
        departments: <DeptCost lcProjects={lcProjects} />,
        performance: <Performance machines={machines} />,
        config: <Config />,
        admin: <Admin />,
    };
    let lastGroup = "";
