...
def register(user_data: UserCreate, db: Session = Depends(get_db)):
    ...
    new_user = User(email=user_data.email, full_name=user_data.full_name, hashed_password=get_password_hash(user_data.password), role=user_data.role, tenant_id="00000000-0000-0000-0000-000000000001")
    db.add(new_user)
    db.commit()
    db.refresh(new_user)
    return new_user
